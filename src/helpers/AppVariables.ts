...
export const incomesMonthlyExample = [
  895, 663, 745, 977, 708, 954, 747, 832, 964, 986, 975, 938, 629, 870, 927,
  597, 757, 829, 693, 856, 537, 870, 960, 558, 577, 956, 541, 661, 820, 883,
  631,
];
export const incomesOneTimeExample = [
  401, 514, 476, 597, 511, 446, 587, 452, 444, 590, 456, 488, 581, 463, 568,
  476, 571, 449, 471, 437, 452, 504, 577, 590, 568, 483, 558, 439, 514, 563,
  527,
];
export const expensesMonthlyExample = [
  895, 663, 745, 977, 708, 954, 747, 832, 964, 986, 975, 938, 629, 870, 927,
  597, 757, 829, 693, 856, 537, 870, 960, 558, 577, 956, 541, 661, 820, 883,
  631,
];
export const expensesOneTimeExample = [
  401, 514, 476, 597, 511, 446, 587, 452, 444, 590, 456, 488, 581, 463, 568,
  476, 571, 449, 471, 437, 452, 504, 577, 590, 568, 483, 558, 439, 514, 563,
  527,
];
